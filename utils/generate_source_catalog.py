...
# r0 [cm] — distance of emission region from central black hole (= R * delta_D)
R0_MU_LN  = 39.4318
R0_SIG_LN =  0.6726
...
def generate_catalog():
    ...
    # ── Sample B0 and r0 from calibrated log-normal distributions ────────────
    B0_G  = np.exp(rng.normal(B0_MU_LN,  B0_SIG_LN,  n_src))   # [G]
    r0_cm = np.exp(rng.normal(R0_MU_LN,  R0_SIG_LN,  n_src))   # [cm]
